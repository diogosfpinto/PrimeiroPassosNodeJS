...
function render(input, out, __component, component, state) {
  ...
  out.w("<h1>Cadastro de livros</h1><form action=\"/livros\" method=\"post\"><input type=\"hidden\" id=\"id\" name=\"id\" value=\"" +
    ...
    "\" placeholder=\"150.25\"></div><div><label for=\"descricao\">Descrição:</label><textarea cols=\"20\" rows=\"10\" id=\"descricao\" value=\"" +
    marko_escapeXmlAttr(data.livro.descricao) +
    "\" name=\"descricao\" placeholder=\"fale sobre o livro\"></textarea></div><input type=\"submit\" value=\"Salvar\"></form>");
